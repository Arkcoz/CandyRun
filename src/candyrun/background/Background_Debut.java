 ...
 * @author lucas
 */
public class Background_Debut extends GameItem {
    ...
    public Background_Debut(Game g, double _x, double _y, int speed) {
        super(g, "background_menu_debut", _x, _y);
